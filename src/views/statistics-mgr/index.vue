  ...
  <div>
    <el-card>
      ...
      <ht-table ref="table" v-loading="isLoading" :data="list" row-key="id">
        ...
        <ht-table-column label="介绍" prop="introduce" />
        <ht-table-column label="容量" prop="volume" />
        <ht-table-column label="耗时" prop="time" />
        <ht-table-column label="分类" prop="category" />
        <ht-table-column label="类型" prop="type" />
        <ht-table-column label="备注" prop="comment" />
