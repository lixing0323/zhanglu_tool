<template>
  <div>
    <el-card>
      <ht-action-panel>
        <template slot="left">
          <el-input v-model="listQuery.group" placeholder="请输入用户组" class="filter-item" @keyup.enter.native="onSearch" />
          <el-input v-model="listQuery.username" placeholder="请输入用户名" class="filter-item" @keyup.enter.native="onSearch" />
          <el-input v-model="listQuery.code" placeholder="请输入用户编码" class="filter-item" @keyup.enter.native="onSearch" />
      ...
      <ht-table ref="table" v-loading="isLoading" :data="list" row-key="id">
        ...
        <ht-table-column label="用户组" prop="group" />
        <ht-table-column label="用户名" prop="username" />
        <ht-table-column label="用户编码" prop="code" />
